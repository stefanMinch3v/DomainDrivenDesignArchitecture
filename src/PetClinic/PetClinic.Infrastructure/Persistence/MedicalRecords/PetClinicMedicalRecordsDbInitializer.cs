namespace PetClinic.Infrastructure.Persistence.MedicalRecords
{
    ...
    internal class PetClinicMedicalRecordsDbInitializer : IInitializer
    {
        private readonly PetClinicMedicalRecordsDbContext db;
        private readonly IEnumerable<IInitialData> initialDataProviders;

        public PetClinicMedicalRecordsDbInitializer(
            PetClinicMedicalRecordsDbContext db,
