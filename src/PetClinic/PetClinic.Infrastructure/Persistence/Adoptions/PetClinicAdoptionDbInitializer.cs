namespace PetClinic.Infrastructure.Persistence.Adoptions
{
    ...
    internal class PetClinicAdoptionDbInitializer : IInitializer
    {
        private readonly PetClinicAdoptionDbContext db;
        private readonly IEnumerable<IInitialData> initialDataProviders;

        public PetClinicAdoptionDbInitializer(
            PetClinicAdoptionDbContext db,
